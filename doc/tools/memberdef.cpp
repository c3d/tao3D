                                 ...
                                 const QCString & /*scopeName*/,MemberDef *md)
{
  ...
  bool latexOn = ol.isEnabled(OutputGenerator::Latex);
  {
    ...
    ol.endMemberDocName();
    ol.startParameterList(FALSE /*!md->isObjCMethod()*/);
  }
  ol.enableAll();
  ...
  while (a)
  {
    ...
    if (a)
    {
      ...
      if (!isDefine)
      {
        ...
        ol.endParameterName(FALSE,FALSE,FALSE /*!md->isObjCMethod()*/);
        if (paramTypeStarted)
        {
          ol.endParameterType();
        }
  ...
  //if (!isDefine)
  {
    ...
    ol.endParameterName(TRUE,defArgList->count()<2,FALSE /*!md->isObjCMethod()*/);
  }
  //else // isDefine
  //{
