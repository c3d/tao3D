...
// ----------------------------------------------------------------------------
{
    ...
    if (!printer)
    {
        ...
        if (screenShotPath != "")
        {
            QImage fb = grabFrameBuffer(screenShotWithAlpha);
            QImage sc = fb.scaled(screenShotScale*fb.size());
            sc.save(screenShotPath);
            screenShotPath = "";
        }
    }
}
...
Name_p Widget::screenShot(Tree_p, text filename, scale sz, bool withAlpha)
// ----------------------------------------------------------------------------
