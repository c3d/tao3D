...
// The Tao module loader uses semantic versioning as implemented by XL
...
// - [ANY CHANGE]: Update the version number to the Tao release version
// - [COMPATIBLE CHANGE]: If interfaces have only been added, then
//   leave COMPATIBLE_VERSION unchanged
// - [INCOMPATIBLE CHANGES]: If interfaces have been removed or modified,
//   then bump COMPATIBLE_VERSION ot the current version

#define TAO_MODULE_API_CURRENT          XL::Version(2,0,0)
#define TAO_MODULE_API_COMPATIBLE       XL::Version(2,0,0)
...
typedef int (*enter_symbols_fn) (XL::Context &context);
typedef int (*delete_symbols_fn)(XL::Context &context);
