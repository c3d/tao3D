...
doc.commands = (cd $$APPINST; echo \"generate_all_doc \\\"./all_documentation.xl\\\"; exit 0 \" > genDoc.ddd; DYLD_LIBRARY_PATH=../Frameworks ./Tao -norepo -nosplash genDoc.ddd)
doc.depends = $$APPINST/Tao
