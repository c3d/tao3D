...
# LLVM dependencies
exists(/usr/local/bin/llvm-config):LLVM_PATH = /usr/local/bin
exists(/opt/local/bin/llvm-config):LLVM_PATH = /opt/local/bin
exists(/usr/bin/llvm-config):LLVM_PATH = /usr/bin
